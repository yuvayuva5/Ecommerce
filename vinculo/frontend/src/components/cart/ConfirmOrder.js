        ...
        <Fragment>
            ...
            <div className="row d-flex justify-content-between">
                <div className="col-12 col-lg-8 mt-5 order-confirm">
                    ...
                    {cartItems.map(item => (
                        <Fragment key={item.product + item.size}> {/* Use a unique key for each item */}
                                ...
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-8 col-lg-6">
                                        <div className="d-flex flex-column">
                                            <Link to={`/product/${item.product}`} className="d-block">{item.name}</Link>
                                            <p className="text-muted">Size: {item.size}</p> {/* Display size */}
                                        </div>
                                    </div>
